# 🔧 Troubleshooting Guide — Docker Compose & LocalStack Dev Studio
...
2. **Check official documentation:**
   - [GitHub Issues for this repo](https://github.com/Pradeeptalari14/tp-localstack-dev/issues)
   - [Studio FAQ](https://pradeeptalari14.github.io/portfolio/tools/localstack-dev/)
